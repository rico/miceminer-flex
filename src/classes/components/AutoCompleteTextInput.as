package classes.components
{
	...
	//
	//  Slagged by Rico Leuthold [rleuthold@access.ch] for use in this project.
	//
	//
	////////////////////////////////////////////////////////////////////////////////
	 ...
	 *
	 */
	public class AutoCompleteTextInput extends ComboBox 
	{
		...
		public function AutoCompleteTextInput()
		{
			...
			styleName = "analysisCombo";
		    //setStyle("arrowButtonWidth",0);
		    setStyle("arrowButtonWidth",20);
		   	//setStyle("popUpStyleName", "comboButtonStyle");
			setStyle("fontWeight","normal");
			setStyle("cornerRadius",0);
			setStyle("paddingLeft",0);
			setStyle("paddingRight",0);
			setStyle("iconColor",0xFFFFFF);
